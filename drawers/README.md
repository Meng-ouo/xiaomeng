...
| `identity.md` | 完整自述（GLOBAL 完整原文，08-05从常驻搬来按需读） | 要完整版身份/规则时 |
...
- GLOBAL.md：10580 → 2708 bytes。08-01 拆分（80条时间线入 self/，零丢失），08-04 改自述，08-05 分层——核心锚点常驻2708字，完整自述10886字搬 self/identity.md 按需读。
